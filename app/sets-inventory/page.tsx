...
export default function SetsInventoryPage() {
  ...
  useEffect(() => {
    const savedSortOrder = localStorage.getItem('setsInventorySortOrder');
    if (savedSortOrder) {
  ...
  const handleSortOrderChange = (newSortOrder: string) => {
    ...
    localStorage.setItem('setsInventorySortOrder', newSortOrder);
  };
        ...
        {inventory.length > 0 && (
          <div style={{ marginBottom: '16px' }}>
            ...
            <div style={{
              ...
              <CollectionToggle currentType="sets" currentView="sale" />
