...
export async function GET(request: NextRequest) {
  try {
    ...
    // zero sets this period. Without this filter, a leaderboard with fewer
    // than 5 real collectors backfilled the remaining ranks with 0-count
    // users in whatever order Prisma happened to return them, showing e.g.
    // "#3 - 0 sets" on a "Top Collectors" list.
