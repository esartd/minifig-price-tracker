...
/**
 * One-time migration endpoint (NO AUTH - delete after use!)
 * Run this ONCE to apply unaccent search migration
 */
export async function GET() {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Migration completed! DELETE THIS ENDPOINT NOW: app/api/run-migration-once/',
      instructions: 'Delete the app/api/run-migration-once/ folder and redeploy'
    });
