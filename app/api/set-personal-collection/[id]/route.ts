...
// PATCH update a set personal collection item
export async function PATCH(
  ...
  try {
    ...
    const updatedItem = await database.updateSetPersonalCollectionItem(id, body);
...
// DELETE a set personal collection item
export async function DELETE(
  ...
  try {
    ...
    const success = await database.deleteSetPersonalCollectionItem(id);
