...
export const THEME_OVERRIDES: { [theme: string]: string } = {
  ...
  'Agents': 'agt030',
  'Atlantis': 'atl024',
  'Avatar The Last Airbender': 'ava007',
  'Back to the Future': 'btf002',
  'Batman I': 'bat026',
  'BIONICLE': 'bio026',
  'Cars': 'crs018',
  'Dimensions': 'dim054',
  ...
  'LEGENDS OF CHIMA': 'loc161',
  'Lightyear': 'dis071',
  'Monster Fighters': 'mof020',
  'NEXO KNIGHTS': 'nex152',
  'Overwatch': 'ow017',
  ...
  'Scala': 'scaFemY07',
  'Scooby-Doo': 'scd014',
  'SpongeBob SquarePants': 'bob024',
  'Teenage Mutant Ninja Turtles': 'tnt053',
  'The Angry Birds Movie': 'ang020',
  'The Incredibles': 'incr010',
  'The LEGO Movie': 'tlm096',
  'The LEGO Movie 2': 'tlm209',
  'The LEGO NINJAGO Movie': 'njo0444',
  'The Lone Ranger': 'tlr021',
  'The Powerpuff Girls': 'ppg005',
  'Toy Story': 'toy026',
  'Trolls World Tour': 'twt018',
  'Ultra Agents': 'uagt037',
  'Unikitty!': 'uni26',
  'Vikings': 'vik041',
};
