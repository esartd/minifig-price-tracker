...
export default function SubcategoryPageClient({
  ...
  const fetchMinifigs = async (themeName: string, subcategoryName: string) => {
    try {
      ...
      // Fetch representative image from subcategories API
      ...
      {coverImage && (
        <div style={{
          ...
          <div style={{
            ...
            <Image
              src={coverImage}
              alt={`${subcategory === 'Uncategorized' ? theme : subcategory} LEGO series representative minifigure`}
              width={120}
              height={120}
              style={{
                objectFit: 'contain',
          ...
          {(() => {
            ...
            return items.map((item) => {
              if (item.type === 'set') {
                ...
                return (
                  <div key={item.key} style={{ gridColumn: 'span 2' }}>
                    <SetAdCard
              ...
              const displayTheme = subcategory === 'Uncategorized' ? theme : `${theme} ${subcategory}`;
                  ...
                  onMouseLeave={(e) => {
                    ...
                    <div style={{
                      ...
                      <Image
                        ...
                        alt={`${minifig.name} - ${displayTheme} LEGO minifigure`}
                        fill
