        ...
        <div style={{
          ...
          <div style={{
            ...
            {isAdmin && (
              ...
              >
                ...
                {translations.articles?.writeArticle || 'Write Article'}
              </Link>
            )}
          </div>
          <p style={{
          ...
          <div style={{
            ...
            <input
              ...
              placeholder={translations.articles?.searchPlaceholder || 'Search articles...'}
              style={{
                width: '100%',
                padding: '14px 20px',
                fontSize: '16px',
        ...
        {(searchQuery || selectedCategory !== 'all') && (
          <div style={{
            ...
            {filteredArticles.length === articles.length
              ? (translations.articles?.showingAll || 'Showing all {count} articles').replace('{count}', articles.length.toString())
              : (translations.articles?.foundResults || 'Found {found} of {total} articles')
                  .replace('{found}', filteredArticles.length.toString())
        ...
        {otherArticles.length === 0 && !featuredArticle ? (
          <div style={{
            ...
            <p style={{ fontSize: '18px', marginBottom: '8px' }}>
              {translations.articles?.noArticlesFound || 'No articles found'}
            </p>
            <p style={{ fontSize: '14px' }}>
              {translations.articles?.tryAdjustingFilters || 'Try adjusting your search or filters'}
            </p>
          </div>
        ) : (
          <div style={{
