                          ...
                          try {
                            await fetch('/api/track-event', {
                              ...
                              body: JSON.stringify({
                                ...
                                metadata: { item_no: minifig.no, item_name: minifig.name, link: 'how_we_calculate_prices' }
                              })
                            });
                          } catch (err) {
                          ...
                          <div style={{
                            ...
                            <button
                              ...
                              style={{
                                ...
                                justifyContent: 'center',
                                gap: '8px',
                                background: addLoading ? '#e5e5e5' : '#3b82f6',
                                color: '#ffffff',
                                border: 'none',
                                borderRadius: '999px',
                                fontSize: 'var(--text-sm)',
                            ...
                            <button
                              ...
                              style={{
                                ...
                                justifyContent: 'center',
                                gap: '8px',
                                background: addPersonalLoading ? '#e5e5e5' : '#3b82f6',
                                color: '#ffffff',
                                border: 'none',
                                borderRadius: '999px',
                                fontSize: 'var(--text-sm)',
