...
const ARTICLES = {
  ...
  'figtracker-vs-bricklink': {
    ...
    en: ['IntoBrick vs Bricklink: Which Should You Use?', 'Compare IntoBrick and Bricklink for LEGO minifigure pricing. Learn what each platform does best, when to reach for which, and how to use them together.'],
    de: ['IntoBrick oder Bricklink: Was sollten Sie nutzen?', 'Vergleichen Sie IntoBrick und Bricklink für die Preisermittlung von LEGO Minifiguren. Erfahren Sie, was jede Plattform am besten kann und wie Sie beide zusammen einsetzen.'],
    fr: ['IntoBrick ou Bricklink : lequel utiliser ?', 'Comparez IntoBrick et Bricklink pour évaluer les minifigurines LEGO. Découvrez les points forts de chaque plateforme et comment les utiliser ensemble.'],
    es: ['IntoBrick o Bricklink: ¿cuál deberías usar?', 'Compara IntoBrick y Bricklink para valorar minifiguras LEGO. Descubre en qué destaca cada plataforma, cuándo usar una u otra y cómo combinarlas.'],
    it: ['IntoBrick o Bricklink: quale conviene usare?', 'Confronta IntoBrick e Bricklink per la valutazione delle minifigure LEGO. Scopri i punti di forza di ciascuna piattaforma e come usarle insieme.'],
    nl: ['IntoBrick of Bricklink: wat kun je het beste gebruiken?', 'Vergelijk IntoBrick en Bricklink voor het prijzen van LEGO-minifiguren. Ontdek waar elk platform in uitblinkt en hoe je ze samen gebruikt.'],
    pl: ['IntoBrick czy Bricklink: z czego korzystać?', 'Porównaj IntoBrick i Bricklink pod kątem wyceny minifigurek LEGO. Dowiedz się, w czym każda platforma jest najlepsza i jak korzystać z obu naraz.'],
    pt: ['IntoBrick ou Bricklink: qual deve usar?', 'Compare o IntoBrick e a Bricklink para avaliar minifiguras LEGO. Saiba em que cada plataforma se destaca e como usá-las em conjunto.'],
    sv: ['IntoBrick eller Bricklink: vilken ska du välja?', 'Jämför IntoBrick och Bricklink för prissättning av LEGO-minifigurer. Lär dig vad respektive plattform är bäst på och hur du använder dem tillsammans.'],
    ja: ['IntoBrick と Bricklink はどちらを使うべきか', 'LEGO ミニフィグの価格調査における IntoBrick と Bricklink を比較します。それぞれの得意分野と、両方を併用する方法を解説します。'],
  },
  'figtracker-vs-brickeconomy': {
    // Also a truncated excerpt: "...tools available. B"
    en: ['IntoBrick vs BrickEconomy: Which LEGO Pricing Tool is Better?', 'Compare IntoBrick and BrickEconomy for LEGO pricing and portfolio tracking. See how their data, coverage and pricing approach differ, and which fits your collection.'],
    de: ['IntoBrick oder BrickEconomy: Welches LEGO-Preistool ist besser?', 'Vergleichen Sie IntoBrick und BrickEconomy für LEGO-Preise und Portfolio-Verwaltung. Sehen Sie, wie sich Daten, Abdeckung und Preislogik unterscheiden.'],
    fr: ['IntoBrick ou BrickEconomy : quel outil de prix LEGO choisir ?', 'Comparez IntoBrick et BrickEconomy pour les prix LEGO et le suivi de portefeuille. Voyez en quoi leurs données, leur couverture et leur approche diffèrent.'],
    es: ['IntoBrick o BrickEconomy: ¿qué herramienta de precios LEGO es mejor?', 'Compara IntoBrick y BrickEconomy para precios LEGO y seguimiento de cartera. Descubre en qué se diferencian sus datos, su cobertura y su enfoque de precios.'],
    it: ['IntoBrick o BrickEconomy: quale strumento di prezzi LEGO è migliore?', 'Confronta IntoBrick e BrickEconomy per i prezzi LEGO e il monitoraggio del portafoglio. Scopri come cambiano dati, copertura e approccio alla valutazione.'],
    nl: ['IntoBrick of BrickEconomy: welke LEGO-prijstool is beter?', 'Vergelijk IntoBrick en BrickEconomy voor LEGO-prijzen en portefeuillebeheer. Zie hoe hun gegevens, dekking en prijsaanpak verschillen.'],
    pl: ['IntoBrick czy BrickEconomy: które narzędzie do wyceny LEGO jest lepsze?', 'Porównaj IntoBrick i BrickEconomy pod kątem wyceny LEGO i śledzenia portfela. Zobacz, czym różnią się dane, zasięg i podejście do wyceny.'],
    pt: ['IntoBrick ou BrickEconomy: qual a melhor ferramenta de preços LEGO?', 'Compare o IntoBrick e o BrickEconomy para preços LEGO e gestão de carteira. Veja como diferem os dados, a cobertura e a abordagem aos preços.'],
    sv: ['IntoBrick eller BrickEconomy: vilket LEGO-prisverktyg är bäst?', 'Jämför IntoBrick och BrickEconomy för LEGO-priser och portföljbevakning. Se hur deras data, täckning och prissättning skiljer sig åt.'],
    ja: ['IntoBrick と BrickEconomy はどちらの LEGO 価格ツールが優れているか', 'LEGO の価格調査とポートフォリオ管理における IntoBrick と BrickEconomy を比較します。データ、収録範囲、価格の考え方の違いを解説します。'],
  },
