...
(function () {
  ...
  // This page is only ever served because the origin was down, so a single
  // successful probe is genuine recovery. (The in-app boundary has to be
  // more careful — see the note in app/global-error.tsx.)
